...
/**
 * KravCard - Entity-specific card for Krav
 * 
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 mb-1">
        ...
        <div className="flex items-center gap-2 flex-shrink-0">
          ...
          {/* UID */}
          {uid && (
            <span className="text-xs font-mono text-green-700 bg-green-100 px-1.5 py-0.5 rounded font-medium">
              [{uid}]
            </span>
          )}
        ...
        <div className="flex items-center gap-2 flex-shrink-0">
          ...
          {viewOptions.showObligatorisk && entity.obligatorisk !== undefined && (
            <div 
              className={entity.obligatorisk ? 'text-green-600' : 'text-blue-600'} 
      ...
      <div className="flex justify-between items-center text-xs text-gray-500">
        <div className="flex items-center gap-3">
          ...
          {/* Tiltak connections */}
          {viewOptions.showRelations && entity.tiltak?.length > 0 && (
            <span className="text-blue-600 font-medium">
              → {entity.tiltak.length} tiltak
            </span>
          )}
