...
export class KravAdapter {
   ...
   * Krav only inherits from parent Krav (via parentId)
   *
   * @param {Object} entity - Current entity/form data
   * @param {Object} parentData - Parent Krav data (if parentId exists)
   * @returns {Object} Inheritance information
   */
  getEffectiveEmneId(entity, parentData) {
    // Krav has only one inheritance source: parent
