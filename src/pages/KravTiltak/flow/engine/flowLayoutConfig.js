...
export const flowLayoutConfig = {
  LAYOUT: {
    vertical_distance_within_emne: 80, // Very compact spacing between entities within emne
    vertical_distance_between_emne: 100, // Very compact gap between emne groups  
    horizontal_distance_between_columns: 120, // Dagre ranksep (LR mode => horizontal)
    min_cluster_height: 150, // Minimal cluster height for maximum compactness
