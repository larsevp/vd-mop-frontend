...
const KravFlowNode = ({ data, selected }) => {
  ...
  return (
    <>
      {hasIncoming && <Handle type="target" position={Position.Left} style={{ background: "#3b82f6", top: '50%' }} />}
      {hasOutgoing && <Handle type="source" position={Position.Left} style={{ background: "#3b82f6", top: '50%' }} />}
